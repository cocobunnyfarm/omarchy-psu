...
BarWidget {
  ...
  function close() { panelOpen = false; scanResults = [] }
    ...
    PanelKeyCatcher {
      ...
      Column {
        ...
        Item {
          ...
          Text {
            anchors.left: parent.left
            text: root.deviceAlias !== "" ? root.deviceAlias
        ...
        Item {
          ...
          Text {
            anchors.left: parent.left
            anchors.verticalCenter: parent.verticalCenter
            text: root.deviceAlias !== "" ? root.deviceAlias : "(선택 안 됨)"
